...
#### Скрин
<img src="screenshots/06_stevens.png"/>
...
#### Демонстрация работы
Код программы в файлах `ping_server.py` и `ping_client.py`. На скрине приведён весь процесс работы программы. Слева окно сервера, справа окно клиента. 2-й пакет оказывается "потерян".
<img src="screenshots/07_ping.png"/>
...
#### Демонстрация работы
Код в файле `ping_client_B.py`
<img src="screenshots/08_ping_b.png"/>
